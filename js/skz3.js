...
Oparate = (function(_super) {
  ...
  function Oparate() {
    return Oparate.__super__.constructor.apply(this, arguments);
  }
  ...
  Oparate.prototype.createRetweet = function(id, _protected) {
    var params, url;
...
$('.retweet').live('click', function() {
  var destroy_status, id, retweeted_id, tweet, _protected;
  tweet = $(this).parent();
  id = tweet.attr('id');
  _protected = $("#" + id + " .protected").attr('alt');
  API.prototype.getStatus(id);
  if (localStorage.getItem("toggle_rt_" + id) === "false") {
    Oparate.prototype.createRetweet(id, _protected);
